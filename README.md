...
A browser for any [linked-object](https://linkedobjects.org) resource — point it at a JSON-LD URL and get a usable UI.

The Linked Object Browser turns raw JSON-LD into interactive views: tasks, folders, profiles, playlists, markdown, and more. It plugs into any pod or server that can deliver linked data — [Solid](https://solidproject.org) servers via [JSS](https://github.com/JavaScriptSolidServer/JavaScriptSolidServer)' `--mashlib-module`, [NosDav](https://nosdav.com) servers, plain static sites, anywhere.
...
Or, with [`nosdav-server`](https://github.com/nosdav/server):
...
- **mashlib.js** is the glue. ~80 lines. Swap out either layer.
